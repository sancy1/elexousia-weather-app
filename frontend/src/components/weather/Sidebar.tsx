...
//         <button
//           onClick={() => setShowAddLocation(!showAddLocation)}
//           className="mx-3 mt-3 flex items-center justify-center gap-2 h-10 rounded-lg bg-primary/10 hover:bg-primary/20 border border-primary/40 text-primary text-sm font-medium transition-all hover:shadow-[0_0_20px_-8px_var(--primary)] group"
//           title="Add location"
//         >
//           <Plus className="h-4 w-4 transition-transform group-hover:rotate-90" />
//           Add location
...
//       {showLabels && showAddLocation && (
//         <div className="mx-3 mt-3 space-y-2 p-3 rounded-lg bg-accent/30 border border-primary/30 backdrop-blur-sm">
//           <input
//             type="text"
//             value={addLocationQuery}
//             onChange={(e) => setAddLocationQuery(e.target.value)}
//             placeholder="Search cities..."
//             className="w-full h-9 px-3 rounded-lg bg-black/40 text-white placeholder:text-gray-400 border border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-transparent transition-all"
//           />
//           <select
//             value={addLocationLabel}
//             onChange={(e) => setAddLocationLabel(e.target.value)}
//             className="w-full h-9 px-3 rounded-lg bg-black/40 text-white border border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-transparent transition-all cursor-pointer"
//           >
//             <option value="Home" className="text-white bg-gray-800">Home</option>
//             <option value="Work" className="text-white bg-gray-800">Work</option>
//             <option value="Travel" className="text-white bg-gray-800">Travel</option>
//           </select>
//           <button
//             onClick={handleAddLocation}
//             className="w-full h-9 rounded-lg bg-gradient-to-r from-primary to-primary-glow hover:from-primary/90 hover:to-primary-glow/90 text-primary-foreground text-xs font-medium transition-all shadow-[0_0_15px_-5px_var(--primary)]"
//           >
//             Save location
//           </button>
//         </div>
...
//             onChange={(e) => setSearchQuery(e.target.value)}
//             placeholder="Search cities..."
//             className="w-full h-9 pl-9 pr-3 rounded-lg bg-black/40 text-white placeholder:text-gray-400 border border-primary/40 focus:outline-none focus:ring-2 focus:ring-primary/60 focus:border-transparent transition-all"
//           />
//         </form>
//       )}
...
//                     }`}
//                   >
//                     <div className="h-7 w-7 rounded-md bg-secondary flex items-center justify-center text-[10px] font-semibold text-white">
//                       {item.city_name.slice(0, 2).toUpperCase()}
//                     </div>
//                   </button>
//                 );
...
//                     }
//                   }}
//                   className={`w-full flex items-center gap-3 px-3 py-1.5 rounded-lg transition-all group relative cursor-pointer ${
//                     active ? "bg-accent/80 shadow-[inset_0_0_0_1px_var(--border)]" : "hover:bg-accent/40"
//                   }`}
//                 >
//                   {active && (
...
//                   )}
//                   <div className="flex-1 text-left min-w-0">
//                     <div className="text-[13px] font-medium truncate text-white">{item.city_name}</div>
...
//                     if (e.key === "Enter" || e.key === " ") {
//                       e.preventDefault();
//                       handleCitySelect(loc.city_name);
//                     }
//                   }}
//                   className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-accent/40 transition-all group cursor-pointer"
//                 >
//                   <div className="h-7 w-7 rounded-md bg-secondary flex items-center justify-center">
//                     <Icon className="h-3.5 w-3.5 text-gray-300" />
//                   </div>
//                   <div className="flex-1 text-left min-w-0">
//                     <div className="text-[13px] font-medium truncate text-white">{loc.city_name}</div>
//                     <div className="text-[10px] text-gray-400 truncate">{loc.label}</div>
//                   </div>
...
//               <>
//                 <div className="flex-1 min-w-0">
//                   <div className="text-[12px] font-medium truncate text-white">{user.name}</div>
...
//             <LoginButton compact={!showLabels} />
//           </div>
//         ) : null}
//       </div>
//     </>
...
//       {mobileOpen && (
//       <div className="md:hidden fixed inset-0 z-50 flex animate-fade-in">
//         {/* Darker backdrop to focus attention on the sidebar */}
//         <div
//           onClick={onMobileClose}
//           className="absolute inset-0 bg-black/70 backdrop-blur-sm"
//         />
        
//         {/* 95% opacity ensures the background content is hidden enough to read sidebar text */}
//         <aside className="relative w-[280px] max-w-[80vw] flex flex-col border-r border-border bg-background/95 backdrop-blur-xl animate-slide-up shadow-2xl">
//           {content(true)}
//         </aside>
//       </div>
//     )}
...
import {
  CloudSun, Plus, Search, MapPin, Briefcase, Home, Plane,
  PanelLeftClose, PanelLeftOpen, X, Trash2, Loader2,
} from "lucide-react";
import { useAuth } from "@/contexts/AuthContext";
import { LoginButton } from "@/components/auth/LoginButton";
import { UserMenu } from "@/components/auth/UserMenu";
      ...
      {showLabels && showAddLocation && (
        <div className="mx-3 mt-3 space-y-2 p-3 rounded-lg bg-accent/30 border border-primary/30 backdrop-blur-sm">
          ...
          <button
            onClick={handleAddLocation}
            disabled={isSaving}
            className="w-full h-9 rounded-lg bg-gradient-to-r from-primary to-primary-glow hover:from-primary/90 hover:to-primary-glow/90 text-primary-foreground text-xs font-medium transition-all shadow-[0_0_15px_-5px_var(--primary)] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSaving ? (
              <>
